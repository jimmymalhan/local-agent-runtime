...
SEED_PATTERNS = [
    ...
    },
    {
        ...
        "description": "Cannot connect to Ollama/model server",
        "fix": "restart Ollama: subprocess.run(['ollama', 'serve']); wait 5s; retry",
        "prompt_patch": "",
    ...
    },
    {
        ...
        "fix": "fall back to qwen2.5-coder:7b; update registry model field",
        "prompt_patch": "",
        "category": "infrastructure",
        "hits": 0,
    },
