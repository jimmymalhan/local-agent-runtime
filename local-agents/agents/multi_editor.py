...
def apply_rename(old_name: str, new_name: str, directory: str) -> dict:
...
def apply_import_update(old_import: str, new_import: str, directory: str) -> dict:
...
def apply_edits(edits: List[Dict]) -> dict:
    """Apply list of {file, old_text, new_text} edits atomically"""
