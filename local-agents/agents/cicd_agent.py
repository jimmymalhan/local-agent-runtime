...
def trigger_workflow(workflow_name=None):
...
def get_failing_tests(run_id=None):
...
def watch_ci(timeout=300, poll_interval=30):
...
def run(task):
    """Route CI/CD actions: trigger, watch, failures, or status"""
