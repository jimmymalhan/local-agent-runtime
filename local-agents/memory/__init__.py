...
Three memory types:
  ...
  ProceduralMemory — reusable patterns from high-quality completions
...
Quick start:
    ...
    # Recall similar tasks before starting a new one
    similar = store.recall_similar("Fix FastAPI auth bug")

    # Build a context string to inject into an agent prompt
...
# Global store — singleton per process
